...
Top 60 upregulated genes in CHIKV-infected mice are shown below for each
macrophage subset.
...
Top 80 genes upregulated in CHIKV vs mock-infected mice are shown below, all T cells
...
```{r "upreg T cells", fig.width = 12, fig.height = 10, out.width = "70%"}
# Select genes to plot
n_gns <- 60
