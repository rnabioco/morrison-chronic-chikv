...
params:
  ...
  ref_dir:      "ref"
  table_dir:    "results/tables/2024-01-03"          # Directory to write tables
  geo_dir:      "results/geo"             # Directory for GEO submission
  overwrite:    false                     # Should tables be overwritten if they already exist?
  so_dir:       "~/Dropbox/Ryan/Projects/morrison-chronic-chikv/results/sobjs/2024-01-03" # Directory for Seurat objects
...
# # CLUSTER 9 MIGHT BE BETTER CHARACTERIZED AS INFILTRATING
# so_mac <- so_mac %>%
#   mutate_meta(
#     mutate,
#     mac_type = ifelse(
#       !!sym(final_clsts$mac) == "9",
#       "infiltrating",
#       mac_type
#     )
#   )
...
Top 50 upregulated genes associated with inflammatory disease are shown below for
...
Key markers are shown below for T cells from mock- and CHIKV-infected samples.
...
Genes upregulated in CHIKV vs mock-infected mice are shown below, all T cells
...
```{r "upreg T cells", fig.width = 10, fig.height = 5}
# Select genes to plot
# filter(
